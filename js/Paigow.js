Paigow = {
	...
	rules:{
		...
		'pairs':{
			'one-pair':'When the hand contains a pair, place the 1st & 2nd highest non-pair cards in hair',
			'two-pair':'When the hand contains 2 pairs...',
			'three-pair':'When the hand contains 3 pairs, place the highest pair in hair',
			'one-pair+joker':'When the hand contains 1 pair & joker. If the highest non-pair card is higher than the pair, put the pair in front and the high card + joker as a pair behind. Otherwise Put the high card + joker in front as a pair with the natural pair behind',
			'two-pair+joker':'When the hand contains 2 pair & joker. If the highest non-pair card is 3 ranks above the highest pair, put it in front with the joker to make 3 pairs. Otherwise put the high pair and front and use the joker to make trips behind',
			'three-pair+joker':'When the hand contains 3 pairs & joker. Put the highest pair in front and make a full house behind with the joker',
		},
		'trips':{
			'no-pair':'When the hand contains trips. Put the 1st & 2nd highest non-trip cards in front with the trips behind',
			'one-pair':'When the hand contains trips + 1 pair. Put the pair in front with the trips behind',
			'two-pair':'When the hand contains trips + 2 pairs. Put the highest pair in front with a full house behind',
			'trips':'When the hand contains 2 trips. Put 2 of the cards from the higher trips in the hair, with the lower trips behind',
			'one-pair+joker':'When the hand contains trips, 1 pair & joker. If the pair is higher than the highest non-pair/non-trips card put it in front with the joker with a full house behind. Otherwise put the pair in front with a 4 of a kind behind',
			'trips+joker':'When the hand contains 2 trips & joker. Put 2 cards from the higher trips in front and make 4 of a kind behind',
		},
		'straight':{
			'no-pair':'When the hand contains a straight place the highest 2 cards in the hair that will not break the straight',
			'one-pair':'When the hand contains a straight + pair place the highest 2 cards in the hair that will not break the straight',
			'two-pair':'When the hand contains a straight + 2 pairs, follow the pairs : two-pair rule',
			'no-pair+joker':'When the hand contains a straight + joker. Put the highest 2 cards in the hair that will not break the straight',
			'one-pair+joker':'When the hand contains a straight + pair + joker. Follow pairs : two-pair rule',
			'two-pair+joker':'When the hand contains a straight + 2 pairs + joker. Follow the pairs : two-pair + joker rule',
		},
		'flush':{
			'no-pair':'When the hand contains a flush place the highest 2 cards in the hair that will not break the flush',
			'one-pair':'When the hand contains a flush + pair place the highest 2 cards in the hair that will not break the flush',
			'two-pair':'When the hand contains a flush + 2 pairs, follow the pairs : two-pair rule',
			'no-pair+joker':'When the hand contains a flush + joker. Put the highest 2 cards in the hair that will not break the flush',
			'one-pair+joker':'When the hand contains a flush + pair + joker. Follow pairs : two-pair rule',
			'two-pair+joker':'When the hand contains a flush + 2 pairs + joker. Follow the pairs : two-pair + joker rule',
		},
		'quads':{
			'no-pair':'When the hand contains quads...',
			'one-pair':'When the hand contains quads + pair. Put the pair in front with quads behind',
			'trips':'When the hand contains quads + trips. Put 2 of the trips in front with the quads behind',
			'no-pair+joker':'When the hand contains quads & joker. Put the highest non-quad in front with joker and quads behind',
