...
var Cards = {
	...
	******************************************************************************************************************************************/
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
	// get the first card in the hand with a name
	///////////////////////////////////////////////////////////////////////////////////////////////////
	getFullName:function(hand,name) {
		for (var i=0; i<hand.length; i++) {
			if (this.getName(hand[i]) == name) {
				return hand[i];
			}
		}
	},
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
	// get an array of names from a hand
	///////////////////////////////////////////////////////////////////////////////////////////////////
	getNames:function(hand) {
		// create an array of names
		var card_names = [];
		for (var i=0;i<hand.length;i++) {
			if (card_names.indexOf(this.getName(hand[i])) === -1) {
				card_names.push(this.getName(hand[i]));
			}
		}
		return card_names;
	},
